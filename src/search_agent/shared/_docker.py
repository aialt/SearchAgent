...
BROWSER_IMAGE_ENV_VAR = "SEARCH_AGENT_BROWSER_IMAGE"
PYTHON_IMAGE_ENV_VAR = "SEARCH_AGENT_PYTHON_IMAGE"

DOCKER_REGISTRY = "ghcr.io/microsoft"
BROWSER_IMAGE = os.getenv(
    BROWSER_IMAGE_ENV_VAR, f"{DOCKER_REGISTRY}/search-agent-browser:0.0.1"
)
PYTHON_IMAGE = os.getenv(
    PYTHON_IMAGE_ENV_VAR, f"{DOCKER_REGISTRY}/search-agent-python-env:0.0.1"
)
